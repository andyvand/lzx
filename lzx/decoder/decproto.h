...
/* decout.c */
void NEAR copy_data_to_output(t_decoder_context *context, int amount, const byte *data);
...
/* decalign.c */
int NEAR decode_aligned_offset_block(t_decoder_context *context, int bufpos, int amount_to_decode);

/* decverb.c */
int NEAR decode_verbatim_block(t_decoder_context *context, int bufpos, int amount_to_decode);

/* decuncmp.c */
int NEAR decode_uncompressed_block(t_decoder_context *context, int bufpos, int amount_to_decode);
